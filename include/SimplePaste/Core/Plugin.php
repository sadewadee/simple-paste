...
class Plugin extends Singleton implements ComponentInterface {
	...
	public function maybe_upgrade() {
		...
		$old_version = get_option( 'simple_paste_version' );
		...
		if ( version_compare($new_version, $old_version, '>' ) ) {
			...
			update_option( 'simple_paste_version', $new_version );
	...
	public function load_textdomain() {
		...
		load_plugin_textdomain( 'simple-paste', false, $path . '/languages' );
	}
	...
	public static function uninstall() {
		foreach ( self::$components as $component ) {
			if ( is_callable( [ $component, 'uninstall' ] ) ) {
				call_user_func( [ $component, 'uninstall' ] );
			}
		}
	}
